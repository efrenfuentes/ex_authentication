defmodule ExAuthenticationWeb.ClientControllerTest do
  use ExAuthenticationWeb.ConnCase

  alias ExAuthentication.Authentication

  @create_attrs %{description: "some description", name: "some name", secret_key: "some secret_key"}
  ...
  def fixture(:client) do
    {:ok, client} = Authentication.create_client(@create_attrs)
    client
  end
