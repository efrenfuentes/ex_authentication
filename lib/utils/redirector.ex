defmodule ExAuthenticationWeb.Utils.Redirector do
    @moduledoc """
    Plug to redirect from a route to another.

    Based in https://www.viget.com/articles/how-to-redirect-from-the-phoenix-router
    """
    import Plug.Conn
